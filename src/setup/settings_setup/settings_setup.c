...
/*   Updated: 2025/05/31 17:35:30 by akovtune         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	setup_settings(t_settings *settings)
{
	...
	settings->north_wall_filepath = ft_strdup("./assets/wall.png");
	settings->south_wall_filepath = ft_strdup("./assets/wall.png");
	settings->west_wall_filepath = ft_strdup("./assets/wall.png");
	settings->east_wall_filepath = ft_strdup("./assets/wall.png");
	return (SUCCESS);
}
